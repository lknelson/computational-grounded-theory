This readme.txt file for this input data was generated on 2017 May 31 by Laura K. Nelson
...
1. Input data for use in analyses done in the paper Computational Grounded Theory: A Methodological Framework
...
3. Date of file collection: 

 These files were collected or created between 2014 and 2016.


4. Information about funding sources that supported the collection of the data:

These files were collected or created for a project supported by a National Science Foundation Graduate Researche Fellow grant and with support from the University of California, Berkeley.
...
A. Concreteness_ratings_Brysbaert_et_al_BRM.xlsx

Dataset collected by Brysbaert, M., Warriner, A.B., & Kuperman, V. Found here: http://crr.ugent.be/archives/1330

Artical about the ratings:
